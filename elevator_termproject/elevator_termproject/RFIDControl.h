...
#ifndef RFIDCONTROL_H_
#define RFIDCONTROL_H_

#define RFID_NRST_PIN    PORTC0
#define RFID_NRST_PORT   PORTC
#define RFID_NRST_DDR    DDRC
#define RFID_NSS_PIN     PORTB0
#define RFID_NSS_PORT    PORTB
#define RFID_NSS_DDR     DDRB
...
#define RFID_SS_EN()    cb(RFID_NSS_PORT,RFID_NSS_PIN)
#define RFID_SS_DIS()   sb(RFID_NSS_PORT,RFID_NSS_PIN)
